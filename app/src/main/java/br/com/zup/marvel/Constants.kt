...
const val GAMORRA_NAME = "Gamorra"
const val GAMORRA_BIO =
...
const val IRONMAN_NAME = "Homem de Ferro"
const val IRONMAN_BIO =
...
const val INVISIBLE_WOMAN_NAME = "Mulher Invisível"
const val INVISIBLE_WOMAN_BIO = "A Mulher Invisível, alter-ego de Susan \"Sue\" Richards, é uma super-heroína de histórias em quadrinhos da editora Marvel Comics. Quando foi criada e durante vários anos chamou-se Garota Invisível. No filme do Quarteto Fantástico de 2005 foi interpretada por Jessica Alba e no de 2015, por Kate Mara."